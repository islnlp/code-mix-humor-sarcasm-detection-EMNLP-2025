...
Cod=pd.read_csv('/data1/aakash/Codemix/Aakash_02/1Humor_Codemix.csv') #codemix
Cod=Cod.dropna()
...
eng = pd.read_csv('/data1/aakash/Codemix/Aakash_02/1Humor_English.csv')
eng = eng[:3000]
...
# t_com.to_csv('train(1400)_data', index=False)
